...
from .attention import JointSelfAttention
...
class DiTBlock(nn.Module):
    def __init__(
        ...
        self.attention_norm = nn.LayerNorm(hidden_size, elementwise_affine=False, eps=1e-6)
        self.attention = JointSelfAttention(hidden_size, num_heads, qkv_bias=qkv_bias)
    ...
    def forward(
        ...
        tokens = tokens + gate_attn * self.attention(
            normalized, coordinates, visibility_mask
        )
